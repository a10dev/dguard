...
namespace logic
{
	namespace common
	{
		...
		public:
			...
			// Important Note!
			//
			// We need to use EVERYWHERE only hash of master-password as encryption key.
			// Now we use master-password directly as encryption key.
			//


			static ::logic::common::MPassKeeper& getPasswordKeeper();
