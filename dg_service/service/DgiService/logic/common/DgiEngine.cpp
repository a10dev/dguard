...
namespace logic
{
	namespace common
	{
		...
		logic::common::MPassKeeper& DgiEngine::getPasswordKeeper()
		{
			auto& conf = getConf();
		...
		bool DgiEngine::changePassword(std::wstring& _currPassword, std::wstring& _newPassword)
		{
			...
			::logic::common::MPassKeeper& dgiMasterPassword = getPasswordKeeper();
		...
		bool DgiEngine::initMasterPassword(::logic::common::MasterPassword _password)
		{
			...
			auto& masterPasswordKeeper = getPasswordKeeper();
